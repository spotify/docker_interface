...
project = 'docker_interface'
copyright = '2017, Till Hoffmann'
...
latex_documents = [
    (master_doc, 'docker_interface.tex', 'docker\\_interface Documentation',
...
import subprocess
subprocess.check_call(['python', 'autodoc.py'])
